...
if __name__ == "__main__":
    ...
    output_dir = os.path.join(os.path.dirname(__file__), args.output_folder)
    if not os.path.exists(output_dir):
        os.makedirs(output_dir)

    log_file = os.path.join(output_dir, '{}.log'.format(args.algo))
    np_file = os.path.join(output_dir, '{}.npy'.format(args.algo))
